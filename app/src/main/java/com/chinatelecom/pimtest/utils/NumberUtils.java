...
public class NumberUtils {
    ...
    public static void main(String agrs []){
        System.out.println(filterNumber("_1 12"));
    }
    ...
    public static boolean isNotificationMessageNumber(String number){
        if(number.startsWith("106")){
            ...
            return true;
        }else if(number.startsWith("1") && number.length()==5){
            return true;
        }else if(number.startsWith("10001")){
            return true;
        }
